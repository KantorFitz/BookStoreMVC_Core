...
namespace BookStoreProject.UI.Migrations
{
    ...
    [Migration("20220702224412_Seeded1")]
            ...
            modelBuilder.Entity("BookStoreProject.UI.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("141264d9-19f9-4167-94e9-3b7e2bd473e1"),
                            Name = "Jesse",
                            Surname = "Gomez"
                        },
                        new
                        {
                            Id = new Guid("2dcd5724-c755-45bd-9aa0-abefe1b73049"),
                            Name = "Anita",
                            Surname = "Gonzalez"
                        },
                        new
                        {
                            Id = new Guid("efacdfa1-585d-4471-9163-5ce9942a428b"),
                            Name = "Erik",
                            Surname = "Edwards"
                        });
                });
